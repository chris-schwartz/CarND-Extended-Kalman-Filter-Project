...
public:
     ...
     */
    void Predict(const double& changeInTime_seconds,
                 const double& ax,
                 const double& ay);
     ...
     */
    void Update(const Eigen::MatrixXd &H, const Eigen::VectorXd &z, const Eigen::MatrixXd &R);
...
private:
    void updateCovarianceMatrix(const double& changeOfTime_seconds,
